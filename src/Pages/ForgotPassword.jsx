    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            try {
                ...
                setSuccess(data.message || 'Mật khẩu đã được gửi đến email của bạn. Vui lòng kiểm tra hộp thư.');
            } catch (e) {
                setSuccess(responseText || 'Mật khẩu đã được gửi đến email của bạn. Vui lòng kiểm tra hộp thư.');
            }
        } catch (err) {
        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-50 via-purple-50 to-gray-100 p-4">
            <div className="w-full max-w-md">
                <div className="text-center mb-8">
                    ...
                    <h2 className="text-3xl font-semibold text-gray-800 mb-2">Quên mật khẩu</h2>
                    <div className="w-24 h-1 bg-gradient-to-r from-indigo-500 to-violet-600 mx-auto rounded-full mb-4"></div>
