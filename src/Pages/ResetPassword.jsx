...
export default function ResetPassword() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setSuccess(message || 'Đặt lại mật khẩu thành công! Bạn sẽ được chuyển đến trang đăng nhập...');
            setTimeout(() => {
                navigate('/login');
            }, 3000);
        } catch (err) {
            ...
            <div className="w-full max-w-md">
                <div className="bg-white rounded-xl shadow-xl overflow-hidden border border-gray-200">
                    <div className="bg-gradient-to-r from-indigo-700 to-purple-700 px-6 py-8 text-center">
                        ...
                        <h2 className="mt-4 text-2xl font-bold text-white tracking-tight">Đặt lại mật khẩu</h2>
                        <p className="mt-2 text-indigo-100 text-sm opacity-90">Nhập mật khẩu mới cho tài khoản của bạn</p>
                    </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            <div>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        disabled={!!success}
                                        className="block w-full px-4 py-2.5 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition"
                            ...
                            <div className="pt-2">
                                <button
                                    ...
                                    className={`w-full flex justify-center items-center px-4 py-3 rounded-lg text-white font-medium bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 transition-all shadow-md ${
                                        isLoading || !!success || !token ? 'opacity-70 cursor-not-allowed' : ''
                                    }`}
                                >
                                    {isLoading ? (
                                        <>
