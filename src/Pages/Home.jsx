...
export default function HomePage() {
  ...
  const banners = [
    {
      id: 1,
      title: "Bespoke Tailoring Collection",
      subtitle: "Craftsmanship Perfected",
      imageUrl:
        "https://images.unsplash.com/photo-1598033129183-c4f50c736f10?ixlib=rb-1.2.1&auto=format&fit=crop&w=1920&q=80",
      cta: "Shop Now",
    },
    {
      id: 2,
      ...
      imageUrl:
        "https://images.unsplash.com/photo-1551232864-3f0890e580d9?ixlib=rb-1.2.1&auto=format&fit=crop&w=1920&q=80",
      cta: "Discover",
    },
    {
      id: 3,
      title: "Black Tie Essentials",
      subtitle: "For Your Most Important Occasions",
      imageUrl:
        "https://images.unsplash.com/photo-1489987707025-afc232f7ea0f?ixlib=rb-1.2.1&auto=format&fit=crop&w=1920&q=80",
      cta: "Explore",
    },
  ];
  ...
  const handleFilter = async (filters) => {
    try {
      ...
      const res = await fetch(
        `http://localhost:8080/api/products/filter?${queryParams.toString()}`
      );
      if (!res.ok) throw new Error(`HTTP error! status: ${res.status}`);
      const data = await res.json();
      setProducts(data);
